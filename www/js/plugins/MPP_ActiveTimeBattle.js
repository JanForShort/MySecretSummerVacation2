...
/*:
 * @plugindesc 【ver.1.5】戦闘システムをアクティブタイムバトルに変更します。
 * @author 木星ペンギン
 *
 * @help ●パーティコマンド
...
(function () {
    ...
    ConfigManager.applyData = function (config) {
        ...
        this.atbMode = this.readAtbValue(config, 'atbMode', 0);
        this.atbSpeed = this.readAtbValue(config, 'atbSpeed', 2);
    };

    ConfigManager.readAtbValue = function (config, name, def) {
